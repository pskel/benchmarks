...
fit4 <- rpart(pct_oracle ~ ite + l1_cache_global_hit_rate + L2_DCM + L3_TCM + l2_l1_read_hit_rate + sm_efficiency,method="class", data=df,control=rpart.control(minsplit=10,minbucket=3))
...
#setEPS()
#postscript("prp_tree_quadro.eps")
