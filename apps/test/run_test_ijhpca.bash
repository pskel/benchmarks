...
do
	...
	do	
		...
		do
			...
			${NUMA_CTL} ${BIN_PSKEL_OMP} ${INPUT_SIZE} ${INPUT_SIZE} ${ITERATIONS} ${TIME_TILE_SIZE} ${GPU_PERCENT} ${GPU_BLOCK_X} ${GPU_BLOCK_Y} ${CPU_THREADS} ${VERBOSE} &>> ${OUTPUT_DIR}/${EXEC}_${INPUT_SIZE}_${ITERATIONS}_${GPU_PERCENT}_${CPU_THREADS}.txt
			sleep 1
