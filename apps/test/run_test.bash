...
ITERATIONS=50
TIME_TILE_SIZE=2
for INPUT_SIZE in 8192 16000 20000 24000
do
	...
	do 
		...
		do
			echo $"Running with INPUT_SIZE = ${INPUT_SIZE} GPU_PARTITION ${GPU_PERCENT}"
			...
			${NUMA_CTL} ${BIN_PSKEL_OMP} ${INPUT_SIZE} ${INPUT_SIZE} ${ITERATIONS} ${TIME_TILE_SIZE} 0  ${GPU_BLOCK_X} ${GPU_BLOCK_Y} ${CPU_THREADS} ${VERBOSE} &>> ${OUTPUT_DIR}/${EXEC}_${INPUT_SIZE}_${ITERATIONS}_1_${CPU_THREADS}_time.txt
			sleep 1 
